...
char* MDString PROTO_LIST ((const char *));
char* MDFile PROTO_LIST ((char *));
char* hmac_md5(char* text, char* key);
char* MDStringLen (const char *, unsigned int len );
...
static void MD5_memcpy(MD5POINTER, MD5POINTER, unsigned int);
static void MD5_memset(MD5POINTER, int, unsigned int);
